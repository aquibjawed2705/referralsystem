...
public class ProductUtils {
	...
	public static Set<String> getFilteredData(String s) {
		 ...
		 * reader.readLine()) != null) { Pattern pattern = Pattern.compile(patternString);
		 * Matcher matcher = pattern.matcher(line); if (matcher.find()) { String
		 * extractedValue = matcher.group(1); System.out.println("Extracted Value: " +
		 * extractedValue); } } } catch (IOException e) { e.printStackTrace(); }
		 */
